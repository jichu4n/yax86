    ...
    case kPICPortCommand:
      if (value & kICW1_INIT) {
        ...
        if (value & kOCW_SELECT) {
          ...
          // This is OCW2.
          if (value == kOCW2_EOI) {  // Non-Specific EOI
            // Find highest priority (lowest index) ISR bit.
            ...
            // Other OCW2 commands (Specific EOI, Rotate) are not implemented
            // as they are not used by MS-DOS or the IBM PC BIOS.
          }
        }
      }
      break;
