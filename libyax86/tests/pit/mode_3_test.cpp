...
static void MockRaiseIRQ0(void* context) { ++irq_0_call_count; }
...
TEST_F(Mode3Test, SystemTimerSquareWave) {
  // Configure Channel 0 for Mode 3, LSB/MSB access, with a reload value of
  // 10000. Control word: 0b00110110
