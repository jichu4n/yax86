...
// src/bios/bios_rom_data yields YAX86_BIOS_ROM_DATA_H and YAX86_BIOS_BUNDLE_H.
// The bundle guard has to be the one generate-header-bundle.js emits, since
// what it gates is whether the file is being compiled inside a bundle.
async function generateRomDataFiles(romFilePath, outputFilePath, symbol) {
  ...
  const cContent = [
    ...
    `#endif // ${bundleGuard}`,
    '',
    `YAX86_MODULE_PRIVATE const uint8_t ${dataSymbol}[] = {`,
